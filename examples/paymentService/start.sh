...
cp ../../anomaly-simulation-service paymentService
cp ../../anomaly-simulation-service authenticationService
cp ../../anomaly-simulation-service persistanceService
cp ../../anomaly-simulation-service riskAssessmentService
